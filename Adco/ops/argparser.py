...
def argparser():
    ...
    parser.add_argument('--save_path', default="../MODELS_result", type=str, help="model and record save path")
    ...
    parser.add_argument('--data_slide_dir', type=str, default="../slides/TCGA-BRCA")
